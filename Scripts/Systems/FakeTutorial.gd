...
var tasks: Array = [
	["J - Jump",           "player_jump",    "Registering jump..."],
	["SHIFT - Sprint",     "player_sprint",  "Enabling sprint..."],
	["Q - Block",          "player_block",   "Equipping shield..."],
	["E - talk",           "player_talk",    "Conmencing speach..."],
	["F - Roll",           "player_roll",    "Enabling roll..."],
]
